...
**[Todo App]** Aimed at creating todo list web application. A user can apply CRUD functionality i.e, add a task, read, update and delete an already added task. 
...
I would like to express my gratitude to [Ibas Majeed](https://www.linkedin.com/in/ibaslogic/) whose tutorials on [React](https://ibaslogic.com/react-tutorial-for-beginners/) have been an invaluable resource in the development of this project. Their expertise and dedication to teaching have been an inspiration to me and have helped me to better understand and implement of Reactjs for web development.
